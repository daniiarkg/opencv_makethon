...
def apply_yolo_object_detection(image_to_process):
    ...
    return [final_image, gboxes, objects_count]
...
def start_image_object_detection(img_path):
    ...
    try:
        ...
        gdata = apply_yolo_object_detection(image)
        # Displaying the processed image on the screen
        cv2.imwrite("test_detect.png", gdata[0])
        return gdata[1:]
...
result, image_cam = cam.read()
cv2.imwrite("test_cam.png", image_cam)
image = 'test_cam.png'
look_for = ['bottle']
